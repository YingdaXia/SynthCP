...
class VGG16_FCN8s_SelfConfid(nn.Module):
    ...
    def __init__(self, num_cls=19, pretrained=True, weights_init=None,
        ...
        self.reduce_dim = nn.Conv2d(4096, 256, 1)
        self.uncertainty = nn.Sequential(
            nn.Conv2d(1024, 400, 3, 1, 1),
            nn.ReLU(inplace=True),
            nn.Conv2d(400, 120, 3, 1, 1),
            nn.ReLU(inplace=True),
            nn.Conv2d(120, 64, 3, 1, 1),
            nn.ReLU(inplace=True),
