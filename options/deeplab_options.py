...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/deeplab/', help='models are saved here')
        parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
        parser.add_argument('--model', type=str, default='deeplab', help='which model to use')
        ...
        parser.add_argument('--snapshot', type=int, default=5000, help='# of iter to save snapshot')
