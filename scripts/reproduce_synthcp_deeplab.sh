...
# SynthCP-joint
IOUNET_NAME=synthcp_deeplab_joint 
IOUNET_MODEL_PATH=checkpoints/iounet/$IOUNET_NAME/iter20000.pth

# SynthCP-separate image-level
#IOUNET_NAME=synthcp_deeplab_image-level 
#IOUNET_MODEL_PATH=checkpoints/iounet/$IOUNET_NAME/iter40000.pth

# SynthCP-separate pixel-level
#IOUNET_NAME=synthcp_deeplab_pixel-level 
#IOUNET_MODEL_PATH=checkpoints/iounet/$IOUNET_NAME/iter24000.pth

# Direct Prediction
#IOUNET_NAME=direct_pred_deeplab 
#IOUNET_MODEL_PATH=checkpoints/iounet/$IOUNET_NAME/iter20000.pth
