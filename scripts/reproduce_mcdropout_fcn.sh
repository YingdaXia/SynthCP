...
LINREG_NAME=mcdropout_linreg_fcn
...
# Run MCDropout
# bash scripts/eval_fcn_mcdropout.sh $SEG_MODEL_NAME 0 0 $EXP_PATH &
# bash scripts/eval_fcn_mcdropout.sh $SEG_MODEL_NAME 1 1 $EXP_PATH &
# bash scripts/eval_fcn_mcdropout.sh $SEG_MODEL_NAME 2 2 $EXP_PATH &
# bash scripts/eval_fcn_mcdropout.sh $SEG_MODEL_NAME 3 3 $EXP_PATH &
# wait
bash scripts/eval_fcn_mcdropout_test.sh $SEG_MODEL_NAME 0 $EXP_PATH &
